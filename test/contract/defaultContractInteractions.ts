...
async function createAuctionInputWithDefaults(
  ...
  return [
    ...
    parameters.auctionedSellAmount ?? ethers.utils.parseUnits("1", "9"),
    parameters.minBuyAmount ?? ethers.utils.parseEther("0.0000000001"),
    parameters.minimumBiddingAmountPerOrder ??
      ethers.utils.parseEther("0.0000000001"),
    parameters.minFundingThreshold ?? ethers.utils.parseEther("0"),
